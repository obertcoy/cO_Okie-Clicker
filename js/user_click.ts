...
export function userClick(clicked : HTMLElement){
...
function clickCookieNumber(clicked: HTMLElement, event: MouseEvent, cookie: number){
...
export function fade(element: HTMLElement, duration: number, finalOpacity : number, callback){

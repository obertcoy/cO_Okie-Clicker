...
import { Achievement, achievements } from "../model/Achievement.js";
...
export function checkAchievementCondition(type: AchievementType, buildingType: BuildingType | null = null){
...
export function displayAchievedAchievement(achievement: Achievement) {
...
export function getAchievementTypeName(type: AchievementType){
